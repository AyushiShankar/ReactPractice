  ...
  const plans = [
    {
      ...
      covers: {
        ...
        C6: { title: "Theft & Fire Cover", value: true },
        C7: { title: "Zero Depreciation Cover", value: false },
        C8: { title: "Engine Secure", value: true },
      },
    },
    {
      name: "Plan 2",
                ...
                <div key={id} className={styles["coverRow"]}>
                  <div className={styles["coverTitleContainer"]}>
                    ...
                    <span className={styles["tooltipWrapper"]}>
                      <img
                        src="./images/toolTipBackground.svg"
                        alt="tool_tip_backkground"
                      />
