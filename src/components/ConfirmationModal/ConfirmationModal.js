...
function ConfirmationModal() {
  ...
  return (
    <div className={style["modal-container"]}>
      <button
        className={style["open-modal-btn"]}
      ...
      {open && (
        <div className={style["modal-backdrop"]}>
          <div className={style["modal-box"]} data-testid="confirmation-modal">
            <h2 className={style["modal-title"]} data-testid="modal-title">
              Confirm Action
            </h2>
            <p className={style["modal-message"]} data-testid="modal-message">
      ...
      {message && (
        <div className={style["action-status"]} data-testid="action-status">
          {message}
        </div>
      )}
    </div>
